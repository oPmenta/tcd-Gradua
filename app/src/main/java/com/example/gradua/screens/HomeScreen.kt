...
@Composable
fun HomeScreen1() {
    // Usando Scaffold aqui apenas para a TopAppBar se necessário,
    // mas sem BottomBar (ela está na MainActivity agora)
    Scaffold(
        topBar = {
            TopAppBar(
                title = {},
                navigationIcon = {
                    IconButton(onClick = { /* Ação opcional de voltar */ }) {
        ...
        Column(
            ...
            Row(
                ...
                Text("ENADE", color = TextGray, modifier = Modifier.padding(16.dp))
            }
